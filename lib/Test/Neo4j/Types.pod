...
This module distribution is experimental.
The experiment is now deemed successful.
This module distribution will soon be merged into the
L<Neo4j-Types|https://metacpan.org/dist/Neo4j-Types>
distribution.

There is an outside chance that the requirements this
module checks for may change before the final release.
